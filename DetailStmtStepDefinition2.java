...
public class DetailStmtStepDefinition2 extends AbstractPageStepDefinition{
	
	WebDriver driver = getDriver();
	
	String sDate = "01/31/2018";
	String sFromDate = "02/25/2018";
	String sToDate = "01/25/2017"; 
	...
	public void detailed_statement_should_get_generated_for_valid_transaction_dates() throws Throwable {
		driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//input[@type = 'date'][0]")).sendKeys(sDate );
		//driver.findElement(By.xpath("//input[@type = 'date'][0]")).sendKeys(sDate );
		driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
	    {
			System.out.println("Detailed statement is displayed");
	...
	public void provide_Future_date_in_From_date() throws Throwable {
		driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//input[@type = 'date'][0]")).sendKeys(sFromDate  );
	...
	public void provide_TO_date_lesser_to_FROM_date() throws Throwable {
		driver.findElement(By.xpath("//input[@type = 'date'][1]")).sendKeys(sToDate  );
	    {
			System.out.println("Detailed statement is not displayed");
		}
	    	}
